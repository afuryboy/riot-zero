...
/***/ (function(module, exports, __webpack_require__) {
	...
	(0, _riotSeedRouter2.default)({
	    '#content': [{ route: '/route1', tag: 'route1' }, { route: '/route2', tag: 'route2' }]
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var observable = _interopDefault(__webpack_require__(6));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _mockjs = __webpack_require__(307);
	...
	// });
	// Mock.Random.custom();
	module.exports = _mockjs2.default.mock(/datas\/menu\.json/, {
	    'list|5': [{
	        'name': '@FIRST',
	        'logo': _mockjs2.default.Random.image()
	    }]
	});
